...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default='pspnet_res34',
                        ...
                        pspnet_res34, pspnet_res18, deeplab)")
    ...
    parser.add_argument("--img_root", type=str, default="/media/phoenixyuwilkie/Dragonfly_sda2/UofT_MBP_PhD/AI_Class/2020/MICCAI_BraTS_2018_Data_Training/train/LGG/image_T1",
                        help="The directory containing the training image dataset.")
    parser.add_argument("--label_root", type=str, default="/media/phoenixyuwilkie/Dragonfly_sda2/UofT_MBP_PhD/AI_Class/2020/MICCAI_BraTS_2018_Data_Training/train/LGG/label",
                        help="The directory containing the training label dataset")
    parser.add_argument("--output_root", type=str, default="./output/train_LGG_pspnet_res34",
