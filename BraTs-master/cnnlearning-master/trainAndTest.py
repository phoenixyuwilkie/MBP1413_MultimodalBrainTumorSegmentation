...
# change all the paths here for your computers
PATH = "/media/phoenixyuwilkie/Dragonfly_sda2/UofT_MBP_PhD/AI_Class/2020/MICCAI_BraTS_2018_Data_Training/HGG"
TEMP = "/media/phoenixyuwilkie/Dragonfly_sda2/UofT_MBP_PhD/AI_Class/tmp" # output went here so I could check before saving into main folder structure
...
if __name__ == '__main__':
    ...
    for z in range(data[0][0].shape[2]):
        ...
        # For visualisation and sanity testing
